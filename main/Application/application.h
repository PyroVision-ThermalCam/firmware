 ...
 */
typedef struct {
    float Max;                                  /**< Maximum temperature value in Degree Celsius within the specified ROI. */
    float Min;                                  /**< Minimum temperature value in Degree Celsius within the specified ROI. */
    union {
        float Average;                          /**< Average temperature value in Degree Celsius within the specified ROI. */
        float Mean;                             /**< Mean temperature value in Degree Celsius within the specified ROI. */
    };
